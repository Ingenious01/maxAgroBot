...
WELCOME_TEXT = (
    "Здравствуйте! 🌾\n\n"
    "Рады приветствовать Вас в чат-боте "
    "«Томский агробизнес».\n\n"
    "Бот помогает представителям малого "
    "агробизнеса быть в курсе свежих новостей, "
    "записаться на мероприятие или личную консультацию.\n\n"
    "Чтобы продолжить взаимодействие с ботом, "
    "необходимо согласиться с обработкой "
...
CONSENT_DECLINED_TEXT = (
    ...
    "Если хотите изменить своё решение, напишите /start"
)
...
AFTER_CONSENT_BUTTONS = [
    [
        {
            "type": "callback",
            "text": "Хочу получать анонсы на почту",
            "payload": "want_email",
        }
    ],
    [
...
MAIN_MENU_TEXT = (
    "Здравствуйте! 🌾\n\n"
    "Я бот «Томский агробизнес».\n"
    "Здесь вы можете следить за новостями, "
    "мероприятиями, семинарами и получать "
    "полезные материалы.\n\n"
    "Основной функционал доступен через "
    "встроенное приложение MAX.\n\n"
